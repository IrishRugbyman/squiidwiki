# PowerShell script to run TypeScript in development (watch) mode
# This script uses the same NodeJS PATH setup as the build script
...
Write-Host "Starting TypeScript in watch mode..." -ForegroundColor Cyan
Write-Host "Press Ctrl+C to stop watching" -ForegroundColor Yellow

try {
    npm run dev
} catch {
    Write-Host "Error running development mode: $_" -ForegroundColor Red
} 